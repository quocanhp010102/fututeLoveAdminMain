      ...
      >
        ...
        <main>
            ...
            <div className="p-4 overflow-y-scroll w-full about_p">
                <h3 className="text-5xl font-semibold text-center">Policy</h3>
                <p class="text-3xl leading-7 text-center p-3">
                ...
                Terms and Conditions, which are accessible at Manga Reader unless
                ...
                but not limited to Manga company. The information that I request will
                be retained on your device and is not collected by me in any way.
                <br />
                <br />
                <h3 className="text-5xl font-semibold text-center">Log Data</h3>
                <br />
                ...
                <br />
                <br />
                <h3 className="text-5xl font-semibold text-center">Cookies</h3>
                <br />
                Cookies are files with a small amount of data that are commonly used
                as anonymous unique identifiers. These are sent to your br /owser from
                the websites that you visit and are stored on your device's internal
                memory.
                <br />
                <br />
                This Service does not use these “cookies” explicitly. However, the app
                may use third-party code and libr /aries that use “cookies” to collect
                ...
                <br />
                <br />
                <h3 className="text-5xl font-semibold text-center">Security</h3>
                <br />
